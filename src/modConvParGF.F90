...
contains
   ...
   subroutine cupGf(its, ite, kts, kte, itf, ktf, mtp, nmp, fscav &
      ...
      call cupEnv(z, qes, he, hes, t, q, po, z1, psur, ierr, p_test, itf, ktf, its, ite, kts, kte)
...
!====
      ...
      do iedt = 1, p_maxens2
         call iedtLoop(ichoice, iedt, ite, its, itf, k22, kte, ktf, kts, mtp, nmp, ierr, kbcon, klcl, kpbl, ktop, start_level &
                     ...
                     , xland, xq_cup, xqes_cup, z, zo, z1, zdo, zo_cup, zqexec, ztexec, zuo, i_cumulus, aa0, aa1_bl &
